...
def shm_read_ushort(data, offset):
    return struct.unpack_from('H', data.read(2, offset))[0]
...
ra_flags = shm_read_ushort(data, SHM_RA_AXIS + SHM_AXIS_FLAGS)
print('ra axis:')
print('   homing: {}'.format(ra_flags & 0x80 != 0))
print('   limiting: {}'.format(ra_flags & 0x100 != 0))
print('   ishomed: {}'.format(ra_flags & 0x200 != 0))
...
dec_flags = shm_read_ushort(data, SHM_DEC_AXIS + SHM_AXIS_FLAGS)
print('dec axis:')
print('   homing: {}'.format(dec_flags & 0x80 != 0))
print('   limiting: {}'.format(dec_flags & 0x100 != 0))
print('   ishomed: {}'.format(dec_flags & 0x200 != 0))
...
focus_flags = shm_read_ushort(data, SHM_FOCUS_AXIS + SHM_AXIS_FLAGS)
print('focus axis:')
print('   homing: {}'.format(focus_flags & 0x80 != 0))
print('   limiting: {}'.format(focus_flags & 0x100 != 0))
print('   ishomed: {}'.format(focus_flags & 0x200 != 0))
